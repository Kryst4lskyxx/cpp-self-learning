...
4. If you are practicing the edit in your own branch or scratch checkout, change only `foundations/module-01-tooling-and-first-program/assignment/main.cpp`.
